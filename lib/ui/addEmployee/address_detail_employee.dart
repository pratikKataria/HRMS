...
class _AddressDetailEmployeeState extends State<AddressDetailEmployee> {
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Container(margin: EdgeInsets.only(top: 16.0), child: Icon(Icons.expand_circle_down, color: Colors.grey))
                            .onClick(() {
                          FocusScope.of(context).unfocus();
                          showCityDialog();
                        }),
                    ...
                    HrmGradientButton(text: "Next").onClick(() {
                      ...
                      addEmployeeRequest.city = selectedCityNameString;
  ...
  void showCityDialog() {
    print(listOfStates.indexOf(stateName!));
    print(listOfCities[listOfStates.indexOf(stateName!)]);
    showDialog(
      context: context,
      builder: (context) {
        return AlertDialog(
            ...
            child: Container(
              ...
              child: SingleChildScrollView(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text("Select city", style: textStyle14px600w),
                    verticalSpace(10.0),
                    ...listOfCities[stateName == null ? 0 : (listOfStates.indexOf(stateName!))].split("|").map((e) {
                      return Container(
                        color: AppColors.inputFieldBackgroundColor,
                        padding: EdgeInsets.all(20.0),
                        margin: EdgeInsets.only(bottom: 10.0),
