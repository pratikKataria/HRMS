...
AddEmployeeRequest copyWith({  String? firstName,
  ...
  set workingdays(String? value) {
    _workingdays = value;
  }

  set shiftTime(String? value) {
    _shiftTime = value;
  }

  set perdayspayout(String? value) {
    _perdayspayout = value;
  }
  ...
  set esic(String? value) {
    _esic = value;
  }

  set uan(String? value) {
    _uan = value;
  }

  set pfemployeecontribution(String? value) {
    _pfemployeecontribution = value;
  }

  set pfemployercontribution(String? value) {
    _pfemployercontribution = value;
  }

  set esicemployeecontribution(String? value) {
    _esicemployeecontribution = value;
  }

  set esicemployercontribution(String? value) {
    _esicemployercontribution = value;
  }
